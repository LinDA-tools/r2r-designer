...
This is responsible for rendering a badge like template holding information about an RDF entity.
...
TODO: simplify the interface by only providing a single RDF entity.
