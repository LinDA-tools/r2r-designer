                  ...
                  "recommend": [
                      {
                          ...
                          "vocabulary.description": [
                              "Search engines including Bing, Google, Yahoo! and Yandex rely on schema.org markup to improve the display of search results, making it easier for people to find the right web pages."
                          ],
                          "vocabulary.title": [
                  ...
                  "recommend": [
                      {
                          ...
                          "uri": [
                              "http://purl.org/healthcarevocab/v1#ProductName"
                          ]
                      }
                  ]
              }
                  ...
                  "recommend": [
                      {
                          ...
                          "vocabulary.description": [
                              "The Measurement Ontology is an ontology in which measurements may be rendered"
                          ],
                          "vocabulary.title": [
                          ...
                          "uri": [
                              "http://www.telegraphis.net/ontology/measurement/measurement#unit"
                          ]
                      }
                  ]
              },
                  ...
                  "recommend": [
                      {
                          ...
                          "vocabulary.description": [
                              ...
                              "This schema describes games with a known state, and few or no random elements."
                          ],
                          "vocabulary.title": [
