...
This generates the mapping in the Sparqlification Mapping Language (http://sparqlify.org/wiki/Sparqlification_mapping_language)
from a js mapping object. Naïve implementation, needs some overhaul.
