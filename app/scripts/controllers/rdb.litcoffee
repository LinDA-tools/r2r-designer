...
To retrieve the HTML template for a specific step:

        $scope.template = (i) -> $scope.steps[i].partial

The steps are specified in descriptively data.
The content is prepended to the corresponding template, and the description is displayed as a side-tip.
        ...
        $scope.steps = [
          ...
          }
          {
            ...
            description: """
              <p><em>Data Source Name</em> is the name of the database</p>
          ...
          }
          {
            ...
            description: """
              <p>These specifications constitute the central part of the transformation. Types and properties should be selected with care, so as to get best possible precision of the transformation.</p>
          ...
          }
          {
            ...
            heading: 'Publish'
            description: """
              <p>A SPARQL endpoint is a service that processes queries against a RDF triple store. Here, the triple store is hypothetical, the queries are translated to SQL, your database is queried, and the results are translated according to your mapping specification.</p>
            """
            content: """
