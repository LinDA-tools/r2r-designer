angular.module('dist').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/main.html',
    "<div class=\"main container\" ng-controller=\"MainCtrl\" style=\"min-height:128em\">\n" +
    "\n" +
    "  <div class=\"header\">\n" +
  ...
  $templateCache.put('partials/publish.html',
    ...
    "  <i class=\"fa fa-check fa-lg\" ng-show=\"success\" style=\"color: #449d44\"></i>\n" +
    "  <!-- <i class=\"fa fa&#45;times fa&#45;lg\" ng&#45;show=\"!success &#38;&#38; !publishing\" style=\"color: #c9302c\"></i> -->\n" +
    "</div>\n"
  );
